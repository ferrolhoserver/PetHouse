...
CREATE TABLE IF NOT EXISTS conhecimento_colaborativo (
    ...
    score_qualidade FLOAT DEFAULT 0,
    
    -- Aprendizado contínuo
    vezes_usado INTEGER DEFAULT 0,
    ultima_vez_usado TIMESTAMP WITH TIME ZONE,
    taxa_acerto FLOAT DEFAULT 0,
...
('procedimentos', 'Castração', NULL, 'Esterilização cirúrgica para controle reprodutivo', 
...
('procedimentos', 'Limpeza Dentária', NULL, 'Profilaxia dental com remoção de tártaro', 
...
('procedimentos', 'Microchipagem', NULL, 'Implante subcutâneo de microchip de identificação', 
...
('exames', 'Hemograma Completo', NULL, 'Análise quantitativa e qualitativa das células sanguíneas', 
...
('exames', 'Ultrassom Abdominal', NULL, 'Exame de imagem ultrassonográfico do abdômen', 
...
('exames', 'Raio-X', NULL, 'Exame radiográfico para avaliação óssea e de tecidos', 
